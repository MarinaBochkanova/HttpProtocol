    ...
    public static void main(String[] args) throws IOException {
        ...
        Stream<Cat> sortCats =
                cats.stream()
                        ...
                        .sorted(Collections.reverseOrder(Comparator.comparing(cat -> cat.getUpvotes()))); //сортировка по убыванию количества голосов, просто так, для себя

        sortCats.forEach(System.out::println);
